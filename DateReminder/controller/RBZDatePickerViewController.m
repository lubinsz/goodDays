...
- (void)viewDidLoad
{
    ...
    //NSLog(@"bblu viewDidLoad....");
    if (self.type) {
        //NSLog(@"bblu 1111:%d",self.type);
        switch ([self.type integerValue]) {
            case RBZEventOnce: [self displayPickerView:kPickerTypeYearly]; break;
...
- (NSAttributedString *)getPickerTypeString:(int)type
{
    ...
    switch (type) {
        ...
        case kPickerTypeMonthly: str = @"佛教节日"; break;
        case kPickerTypeYearly: str = @"日期"; break;
    }
